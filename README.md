...
* asts/ : Directory where graphviz (.gz) files of parse trees and their corresponding image files (.png) generated when running the parser are stored.
* asts_solution/ : Directory where the solution parse tree .gz and .png files are stored.
